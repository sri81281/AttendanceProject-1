...
try {
	...
	String query = "insert into AttendInfo (userId ,Date,Available) values(?,sysdate(),?)";
    PreparedStatement stmt=con.prepareStatement(query);
    stmt.setString(1, n);
    stmt.setString(2, p);
    stmt.executeUpdate();
	con.close();
	message="you are successfully give the Attendance";
	
}
catch(Exception e)
{
	e.printStackTrace();
	message = "you are already give your attendance";
