...
<ul>
  ...
  <li><a href="#news">leave Form</a></li>
  ...
  <li class="profile" ><h3><%= name  %></h3></li>
	...
	<div class="container">
		<form action="home.jsp">
			<button class="button" type="submit">Present</button>
		</form>
	</div>
...
<footer class="abc">
  <h3>Contact us <br> <a style="color:white" href="mailto:nadanzoho@gmail.com">nadanzoho@gmail.com</a></h3>
  
  <address>
unknown Corp. Limited,Nadangadu-614804,TamilNadu
</address>
<br>
</footer>
</body>
